...
void projection_3x3_mat(int width, int height, float * dest) {
    ...
    dest[3] = 0.0,         dest[4] = -2.0 / height, dest[5] = 0.0, 
    dest[6] = -1.0,        dest[7] = 1.0,           dest[8] = 1.0;
}
...
int main(int argc, char *argv[]) {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    projection_3x3_mat(window_width, window_height, projectionMatrix);
    ...
    float tmp_matrix[9];
    multiply_3x3_mat(projectionMatrix, translationMatrix, tmp_matrix);
    float tmp_matrix_2[9];
    multiply_3x3_mat(tmp_matrix, rotationMatrix, tmp_matrix_2);
    float tmp_matrix_3[9];
    multiply_3x3_mat(tmp_matrix, scaleMatrix, tmp_matrix_3);

    uniformValues.matrix[0] = tmp_matrix_3[0];
    uniformValues.matrix[1] = tmp_matrix_3[1];
    uniformValues.matrix[2] = tmp_matrix_3[2];
    uniformValues.matrix[3] = 0; //padding
    uniformValues.matrix[4] = tmp_matrix_3[3];
    uniformValues.matrix[5] = tmp_matrix_3[4];
    uniformValues.matrix[6] = tmp_matrix_3[5];
    uniformValues.matrix[7] = 0; //padding
    uniformValues.matrix[8] = tmp_matrix_3[6];
    uniformValues.matrix[9] = tmp_matrix_3[7];
    uniformValues.matrix[10] = tmp_matrix_3[8];
    uniformValues.matrix[11] = 0; //padding
