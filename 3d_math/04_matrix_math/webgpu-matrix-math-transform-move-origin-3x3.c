...
int main(int argc, char *argv[]) {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    float moveOriginMatrix[9];
    translation_3x3_mat(-50.0, -75.0, moveOriginMatrix);
    

    float tmp_matrix[9];
    multiply_3x3_mat(translationMatrix, rotationMatrix, tmp_matrix);
    float tmp_matrix_2[9];
    multiply_3x3_mat(tmp_matrix, scaleMatrix, tmp_matrix_2);
    float tmp_matrix_3[9];
    multiply_3x3_mat(tmp_matrix_2, moveOriginMatrix, tmp_matrix_3);
