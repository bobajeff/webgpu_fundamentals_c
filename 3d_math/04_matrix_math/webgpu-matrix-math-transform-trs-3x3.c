...
int main(int argc, char *argv[]) {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    uniformValues.matrix[0] = tmp_matrix_2[0];
    uniformValues.matrix[1] = tmp_matrix_2[1];
    uniformValues.matrix[2] = tmp_matrix_2[2];
    uniformValues.matrix[3] = 0; //padding
    uniformValues.matrix[4] = tmp_matrix_2[3];
    uniformValues.matrix[5] = tmp_matrix_2[4];
    uniformValues.matrix[6] = tmp_matrix_2[5];
    uniformValues.matrix[7] = 0; //padding
    uniformValues.matrix[8] = tmp_matrix_2[6];
    uniformValues.matrix[9] = tmp_matrix_2[7];
    uniformValues.matrix[10] = tmp_matrix_2[8];
