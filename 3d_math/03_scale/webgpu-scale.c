...
int main(int argc, char *argv[]) {
  ...
  const uint64_t uniformBufferSize = (4 + 2 + 2 + 2 + 2) * 4;
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    uniformValues.translation[0] = translation[preset][0];
    uniformValues.translation[1] = translation[preset][1];
    uniformValues.rotation[0] = cosf(rotation_degree);
    uniformValues.rotation[1] = sinf(rotation_degree);
    uniformValues.scale[0] = scale[0];
    uniformValues.scale[1] = scale[1];
